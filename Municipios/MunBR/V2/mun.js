require([
    ...
    var slider = new Slider({
      ...
      max: 2015,
      values: [2000],
      step: [1872, 1900, 1911, 1920, 1933, 1940, 1950, 1960, 1970, 1980, 1991, 2000, 2001, 2005, 2007, 2010, 2013, 2014, 2015],
      label: [1872, 1900, 1911, 1920, 1933, 1940, 1950, 1960, 1970, 1980, 1991, 2000, 2001, 2005, 2007, 2010, 2013, 2014, 2015],
      visibleElements: {
          labels: true,
          rangeLabels: true,
      },
      steps: [1872, 1900, 1911, 1920, 1933, 1940, 1950, 1960, 1970, 1980, 1991, 2000, 2001, 2005, 2007, 2010, 2013, 2014, 2015],
      precision: 1,
      tickConfigs: [{
        mode: "position",
...
//map.addMany([resultsLayer, featureLayer]);
    ...
    */
    function animate(startValue) {
        ...
        var array = [1872, 1900, 1911, 1920, 1933, 1940, 1950, 1960, 1970, 1980, 1991, 2000, 2001, 2005, 2007, 2010, 2013, 2014, 2015];
        var indexValue;
